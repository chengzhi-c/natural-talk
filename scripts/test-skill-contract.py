...
REQUIRED = {
    "SKILL.md": ("C6", "F6", "F7", "F8", "F8（含台词）", "留白", "语义", "只输出正文", "硬事实", "指定动作或检查项", "范围不明时先问", "“给3步/3条”=恰好3", "N9 只保护具体且有共享属性", "fiction 正文中的角色台词不算资料引文", "始终改掉“很久，久到……”这一表层句式", "延后揭示本身不构成豁免", "原因暂未揭示本身不是语义缺失", "角色可以撒谎、误判或不可靠", "F1–F8 只能删除、重排或改写原文已有信息"),
    ...
    "references/rules-dialogue.md": ("C6", "声音填满空间", "“给3步/3条”=恰好3"),
    ...
    "templates/system-prompt-standard.txt": ("C6", "声音填满空间", "“给3步/3条”=恰好3", "只含改写后的全文", "明确作为资料引用的引文", "延后揭示本身不构成豁免"),
    "templates/system-prompt-lite.txt": ("C6", "B5", "“给3步/3条”=恰好3", "定向加入 B5 与 C6", "明确作为资料引用的引文", "延后揭示本身不构成豁免"),
}
