...
| 特性 | Natural Talk | shuorenhua | stop-slop | humanizer |
|------|--------------|------------|-----------|-----------|
| **目标场景** | 对话、聊天 | 文本改写 | 英文长文写作 | 维基百科式内容 |
| **使用方式** | System prompt 注入 | 主动调用改写 | System prompt | 改写工作流 |
| **语言** | 中英双语 | 中英双语 | 英文优先 | 英文 |
| **文档长度** | 完整版 8000字 / 精简版 2000字 | 多文件模块化 | 中等 | 长文档 |
| **学习成本** | 低（三秒口诀） | 中 | 中 | 高 |
| **量化指标** | ✅ 明确上限 | ✅ Tier 分级 | ✅ 5维打分 | ❌ |

**定位差异**：
- **vs shuorenhua**：我是"预防"（对话时自动生效），它是"治疗"（事后改写）
- **vs stop-slop**：我是中文对话优先，它是英文写作优先
- **vs humanizer**：我是即时聊天场景，它是长文内容编辑
- **vs ai-flavor-remover**：我是规则集，它是完整改写工作流
...
Natural Talk 可以与以下 skill **同时使用**：

✅ **taste-skill**：我管对话风格，它管 UI 设计  
✅ **humanizer-academic-zh**：我管聊天，它管学术论文  
✅ **code-review 类 skill**：互不干扰  

⚠️ **避免同时使用**：
- shuorenhua：功能重复 85%，会互相干扰
- ai-flavor-remover：功能重复 50%，可能产生冲突
- stop-slop（部分兼容）：英文长文场景可能冲突
